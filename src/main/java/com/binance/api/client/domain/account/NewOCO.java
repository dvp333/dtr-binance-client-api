...
public class NewOCO {
     ...
     */
    public NewOCO(String symbol, OrderSide side, String quantity, String price, String stopPrice, String trailingDelta) {
        this.symbol = symbol;
        this.side = side;
    ...
    public String getTrailingDelta() {
        return trailingDelta;
    }

    public void setTrailingDelta(String trailingDelta) {
        this.trailingDelta = trailingDelta;
    }
