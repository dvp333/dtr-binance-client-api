...
public interface BinanceApiService {
    ...
    Call<NewOrderResponse> newOrder(@Query("symbol") String symbol, @Query("side") OrderSide side, @Query("type") OrderType type,
                                    ...
                                    @Query("recvWindow") Long recvWindow, @Query("timestamp") Long timestamp, @Query("trailingDelta") Long trailingDelta);
    ...
    Call<NewOCOResponse> newOCO(@Query("symbol") String symbol, @Query("listClientOrderId") String listClientOrderId, @Query("side") OrderSide side,
                                ...
                                @Query("limitIcebergQty") String limitIcebergQty, @Query("trailingDelta") String trailingDelta, @Query("stopClientOrderId")String stopClientOrderId, @Query("stopPrice") String stopPrice,
